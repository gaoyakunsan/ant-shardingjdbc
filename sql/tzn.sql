...
CREATE TABLE `menu` (
  ...
  `button_id` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '按钮唯一值',
  ...
  `type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '类型 (1:菜单2:按钮)',
...
/*Table structure for table `product0` */
...
/*Data for the table `product0` */

insert  into `product0`(`id`,`productName`,`price`,`stock`) values 
(516196368998465536,'菠萝',2,100),
(516196369040408576,'橘子',2,100),
(516196369086545920,'西瓜',2,100),
(516196369128488960,'草莓',2,100),
(516196369174626304,'猕猴桃',2,100);
...
insert  into `product1`(`id`,`productName`,`price`,`stock`) values 
(516196368612589569,'香蕉',2,100),
(516196369019437057,'菠萝1',2,100),
(516196369057185793,'橘子1',2,100),
(516196369107517441,'杏子',2,100),
(516196369153654785,'芒果',2,100);
...
CREATE TABLE `score` (
  ...
  `zfp_score` int(11) DEFAULT NULL,
  `ldty` float DEFAULT NULL,
  `ldty_score` int(11) DEFAULT NULL,
  `wqty` float DEFAULT NULL,
  `wqty_score` int(11) DEFAULT NULL,
  `lxt` float DEFAULT NULL,
  `lxt_score` int(11) DEFAULT NULL,
  `tqq` float DEFAULT NULL,
  `tqq_score` int(11) DEFAULT NULL,
  `phm` float DEFAULT NULL,
  `phm_score` int(11) DEFAULT NULL,
